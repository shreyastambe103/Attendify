    ...
    public class MarkAttendanceGUI extends JFrame {
        ...
        private JButton selectAllButton; // Added select all button
        ...
        private void initComponents() {
            ...
            selectAllButton = new JButton("Select All"); // Adding Select All button
            selectAllButton.setBackground(new Color(128, 128, 128)); // Gray color
            selectAllButton.setForeground(Color.BLACK);
            selectAllButton.setFont(new Font("Arial", Font.PLAIN, 20)); // Increased font size
            selectAllButton.addActionListener(e -> selectAll()); // ActionListener to select all checkboxes
